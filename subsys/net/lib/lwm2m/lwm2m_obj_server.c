...
static struct lwm2m_engine_obj_field fields[] = {
	...
	OBJ_FIELD_DATA(SERVER_COMMUNICATION_RETRY_COUNT_ID, RW_OPT, U32),
	OBJ_FIELD_DATA(SERVER_COMMUNICATION_RETRY_TIMER_ID, RW_OPT, U32),
	OBJ_FIELD_DATA(SERVER_COMMUNICATION_SEQUENCE_DELAY_TIMER_ID, RW_OPT, U32),
	OBJ_FIELD_DATA(SERVER_COMMUNICATION_SEQUENCE_RETRY_TIMER_ID, RW_OPT, U32),
