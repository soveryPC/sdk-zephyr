...
static void os_mgmt_reset_work_handler(struct k_work *work)
{
	...
	// Since FOTA via BLE call this and reboot the device abruptly
	// It was decided to change to a controlled reboot sequence to ensure threads are terminated
	// in a controlled manner
	reboot_handler_initiate_reboot();
}
